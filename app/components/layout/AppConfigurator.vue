...
function updateColors(type: string, color: { name: string; palette: Record<string, string> }) {
  if (type === 'primary') {
...
function applyTheme(type: string, color: { name: string; palette: Record<string, string> }) {
  if (type === 'primary') {
